          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white dark:bg-neutral-800 rounded-xl shadow-lg p-8 border border-slate-200 dark:border-neutral-700 transition-colors duration-300">
              ...
              <div className="space-y-6">
                {/* COMP1511 Note */}
                <div className="border border-slate-200 dark:border-neutral-700 rounded-lg p-6 transition-colors duration-300">
                  ...
                  <div className="bg-slate-100 dark:bg-neutral-900 rounded p-4 text-sm font-mono text-slate-700 dark:text-neutral-300 transition-colors duration-300">
                    #include &lt;template&gt;
                    <br />
                    class Business &#123; ... &#125;
                  </div>
