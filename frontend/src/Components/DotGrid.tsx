...
const DotGrid: React.FC<DotGridProps> = ({
  ...
  return (
    <section
      className={`p-0 flex items-center justify-center min-h-screen h-full w-full relative ${className}`}
      style={style}
    >
      <div ref={wrapperRef} className="w-full h-full min-h-screen relative">
        <canvas
          ref={canvasRef}
