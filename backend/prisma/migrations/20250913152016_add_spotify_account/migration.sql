...
-- CreateTable
CREATE TABLE "public"."SpotifyAccount" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "SpotifyAccount_userId_key" ON "public"."SpotifyAccount"("userId");
...
-- AddForeignKey
ALTER TABLE "public"."SpotifyAccount" ADD CONSTRAINT "SpotifyAccount_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
